...
public class Main {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            double moonOrbitalVelocity = 1.022/6;
            ...
            RenderablePointMass moon1 = new RenderablePointMass(earthMoonDistance, 0, orbitingPointMassMass*100, 0, moonOrbitalVelocity, 15, Color.red);
            RenderablePointMass moon2 = new RenderablePointMass(-earthMoonDistance, 0, orbitingPointMassMass, 0, moonOrbitalVelocity*.8, 15, Color.green);
